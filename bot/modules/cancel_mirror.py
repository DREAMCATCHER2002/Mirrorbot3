    ...
    if len(args) > 1:
        ...
        with download_dict_lock:
            ...
            try:
                ...
                pass
    if len(args) == 1:
        msg = f"<b>Please Reply to the</b> <b>/{BotCommands.MirrorCommand}</b> <b>Message which was used to start the download or send</b> <b>/{BotCommands.CancelMirror} GID</b> <b>to cancel it!</b>"
        if mirror_message and mirror_message.message_id not in keys:
            if BotCommands.MirrorCommand in mirror_message.text or \
               ...
               BotCommands.UnzipMirrorCommand in mirror_message.text:
                msg1 = "<b>Mirror Already Have Been Cancelled</b>"
